...
public class UDIPruebaEstudiantes {
    ...
    public static void main(String[] args) {
        ...
        UsodeinstruccionesEst[] grupo = new UsodeinstruccionesEst[n];
        ...
        for (int i = 0; i < n; i++) {
            ...
            grupo[i] = new UsodeinstruccionesEst(nombre, nota1, nota2, nota3, notaProyecto);
        }
